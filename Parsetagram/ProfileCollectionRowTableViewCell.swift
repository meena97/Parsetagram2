...
class ProfileCollectionRowTableViewCell: UITableViewCell {
    ...
    override func awakeFromNib() {
        ...
        // Initialization code
        var taps = [
            UITapGestureRecognizer(target: self, action: #selector(ProfileCollectionRowTableViewCell.onTappedLeftPhoto)),
            UITapGestureRecognizer(target: self, action: #selector(ProfileCollectionRowTableViewCell.onTappedCenterPhoto)),
            UITapGestureRecognizer(target: self, action: #selector(ProfileCollectionRowTableViewCell.onTappedRightPhoto)),
            ];
